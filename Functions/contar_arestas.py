...
def contar_arestas(adjacencias, valorado: bool, digrafo : bool) -> int:
     num_arestas = 0
     if valorado:
...
class TestContarArestas(unittest.TestCase):
    def test_1(self):
        ...
        self.assertEqual(contar_arestas([
            ...
            [0, 1, 0, 1],
            [0, 0, 1, 0]
        ],valorado=False, digrafo=False), 3)
    ...
    def test_2(self):
        ...
        self.assertEqual(contar_arestas([
            ...
            [1, 0, 1],
            [0, 1, 1]
        ],valorado=False, digrafo=False), 4)
    ...
    def test_3(self):
        ...
        self.assertEqual(contar_arestas([
            ...
            [2, 0, 2],
            [2, 2, 0]
        ],valorado=False, digrafo=False), 6)
    ...
    def test_4(self):
        ...
        self.assertEqual(contar_arestas([
            ...
            [20, 0, 15],
            [5, 15, 0]
        ],valorado=True, digrafo=False), 40)
    ...
    def test_5(self):
        ...
        self.assertEqual(contar_arestas([
            ...
            [3, 0, 0],
            [2, 0, 0]
        ], valorado=True, digrafo=False), 23)
    ...
    def test_6(self):
        ...
        self.assertEqual(contar_arestas([
            ...
            [0, 0, 0],
            [0, 0, 0]
        ],valorado=False, digrafo=False), 2)
